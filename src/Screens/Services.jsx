        ...
        <div className="center-wrapper">
          <div className="container">
            ...
            <div className="text-section">
              <h1 className="services-text font-color-1 font-weight-700">
                RADIOLOGY
              </h1>
              <p className="font-color">
                {" "}
                Our facility provides an{" "}
                <span className="highlighted-text">
                  easy out-patient oriented accessibility
                </span>{" "}
                to the needed{" "}
                <span className="highlighted-text">X-ray views</span>. This will
                give patients and doctors lesser time to wait for the needed{" "}
                <span className="highlighted-text">x-ray film</span> results.{" "}
              </p>
          ...
          <div className="container">
            ...
            <div className="text-section">
              ...
              <p className="font-color">
                ...
                We provide{" "}
                <span className="highlighted-text">
                  out-patient lab tests
                </span>{" "}
                that can be done and released before the next follow-up
                consultation.{" "}
              </p>
        ...
        <div className="center-wrapper">
          <div className="container">
            ...
            <div className="text-section">
              ...
              <p className="font-color">
                {" "}
                Our ultrasound services provide a comprehensive and reliable
                service in{" "}
                <span className="highlighted-text">
                  general ultrasound, obstetric, and gynecological scanning.
                </span>{" "}
                Our doctors are radiologists with ultrasound training and OBGYN
                practitioners who are Fetal Medicine and Gynecological
        ...
        <div className="center-wrapper">
          <div className="container">
            ...
            <div className="text-section">
              ...
              <p className="font-color">
                {" "}
                Lorem ipsum dolor sit amet consectetur. Orci malesuada elementum
                pellentesque ullamcorper. Vel morbi venenatis est rhoncus urna.
                Enim ultrices viverra faucibus nisl purus semper.{" "}
              </p>
